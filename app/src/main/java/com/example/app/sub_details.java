...
public class sub_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView myimageView= (ImageView) findViewById(R.id.image_view1);
        myimageView.setImageResource(R.drawable.book_111);
